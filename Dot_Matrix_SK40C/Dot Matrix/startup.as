	...
	; Compiler options:
	;
	; -oDot Matrix.cof -mDot Matrix.map --summary=default --output=default \
	; Dot Matrix.p1 --chip=16F887 -P --runtime=default \
	; --opt=default,+asm,-debug,-speed,+space,9 --warn=0 -D__DEBUG=1 \
	; --addrqual=ignore -g --asmlist --errformat=Error   [%n] %f; %l.%c %s \
